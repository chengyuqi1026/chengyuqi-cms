...
<form name="articleform"  id="articleform">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="title" value="${article.title}" name="title"  placeholder="请输入文章标题">
  </div>
 ...
 <div class="form-group">
    ...
    <img alt="hjjhjh" src="/pic/${article.picture}">
    <input type="hidden" name="name" value="${article.picture}">
    <input type="file" class="form-control-file" id="file" name="file">
  </div>
  
  <div class="form-group">
    <label for="content1">文章内容</label>
    <textarea name="content1" id="contentId" cols="200" rows="200" style="width:1000px;height:200px;visibility:hidden;">${content1}</textarea> 
